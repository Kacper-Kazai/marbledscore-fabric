...
public class MarbledsCoreItems {
    public static final Item STEEL_BLOCK = registerBlock(MarbledsCoreBlocks.STEEL_BLOCK);
    ...
    public static Item registerItem(String name, Item item) {
        return registerItem(ResourceLocation.fromNamespaceAndPath(MarbledsCore.MODID, name), item);
    }
